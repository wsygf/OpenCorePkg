  ...
  )
{
  ...
  ASSERT_EQUALS (This->Width,  BOOT_SELECTOR_BUTTON_DIMENSION * DrawContext->Scale);
  ASSERT_EQUALS (This->Height, BOOT_SELECTOR_BUTTON_DIMENSION * DrawContext->Scale);
...
GLOBAL_REMOVE_IF_UNREFERENCED GUI_OBJ_CLICKABLE mBootPickerLeftScroll = {
  {
    ...
    &mBootPickerView,
    {
      0, 0, BOOT_SELECTOR_BUTTON_DIMENSION, BOOT_SELECTOR_BUTTON_DIMENSION,
      InternalBootPickerLeftScrollDraw,
      InternalBootPickerLeftScrollPtrEvent,
      NULL,
  ...
  )
{
  ...
  mBootPickerLeftScroll.Hdr.Obj.Height = BOOT_SELECTOR_BUTTON_DIMENSION * GuiContext->Scale;
  mBootPickerLeftScroll.Hdr.Obj.Width  = BOOT_SELECTOR_BUTTON_DIMENSION * GuiContext->Scale;
  mBootPickerLeftScroll.Hdr.Obj.OffsetX = BOOT_PICKER_SCROLL_SPACE;
  ...
  mBootPickerRightScroll.Hdr.Obj.Height = BOOT_SELECTOR_BUTTON_DIMENSION * GuiContext->Scale;
  mBootPickerRightScroll.Hdr.Obj.Width  = BOOT_SELECTOR_BUTTON_DIMENSION * GuiContext->Scale;
  mBootPickerRightScroll.Hdr.Obj.OffsetX = mBootPickerView.Width - mBootPickerRightScroll.Hdr.Obj.Width - BOOT_PICKER_SCROLL_SPACE;
  ...
  //
  ContainerMaxWidth   = mBootPickerView.Width - mBootPickerLeftScroll.Hdr.Obj.Width - 2 * BOOT_PICKER_SCROLL_SPACE - mBootPickerRightScroll.Hdr.Obj.Width - 2 * BOOT_PICKER_SCROLL_SPACE;
